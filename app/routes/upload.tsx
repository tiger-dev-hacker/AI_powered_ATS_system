...
const Upload = () => {
    ...
    const handleAnalyze = async ({
        ...
        if (!imageFile.file) return setStatusText("Error: Failed to convert PDF file to image");
        ...
        try {
            const parsedFeedback = typeof feedbackText === "string" && feedbackText.trim().startsWith("{")
            ...
            return setStatusText("Error: Failed to parse feedback response");
        }
        ...
        <main className="bg-[url('/images/bg-main.svg')] bg-cover">
            ...
            <section className="main-section">
                <div className="page-heading py-16">
                    <h1>
                        Smart feedback for you dream job
                    </h1>
                    {isProcessing ? (
                        <>
                            <h2>{statusText}</h2>
